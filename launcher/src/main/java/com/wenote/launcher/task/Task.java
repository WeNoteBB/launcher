...
import com.wenote.launcher.utils.DispatcherExecutor;
...
public abstract class Task implements ITask {
    ...
    protected Context mContext = _TaskDispatcher.getContext();
    protected boolean mIsMainProcess = _TaskDispatcher.isMainProcess();// 当前进程是否是主进程
